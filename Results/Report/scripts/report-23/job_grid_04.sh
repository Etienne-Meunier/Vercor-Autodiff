#!/bin/bash
# Report 23: loss-landscape grid for the top-3 T/S-difference observable, c_k columns [04, 08).
...
export REPORT21_GRID_I0=04
export REPORT21_GRID_I1=08
