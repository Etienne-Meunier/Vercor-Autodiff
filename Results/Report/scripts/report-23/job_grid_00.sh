#!/bin/bash
# Report 23: loss-landscape grid for the top-3 T/S-difference observable, c_k columns [00, 04).
...
export REPORT21_GRID_I0=00
export REPORT21_GRID_I1=04
