#!/bin/bash
# Report 23: multistart corner 1 (c_k=0.15, c_eps=1.00), 200 iterations, top-3 T/S-difference
...
export REPORT21_OUT_DIR=$HOME/code/Vercor-Autodiff/Results/Report/figures/report-23-tsdiff-paper200/start_1
cd ~/code/Vercor-Autodiff
python Results/Report/scripts/report-21/fit.py
echo "=== REPORT23 START200 1 DONE ==="
