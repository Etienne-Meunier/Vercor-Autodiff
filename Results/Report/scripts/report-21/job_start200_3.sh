#!/bin/bash
# Report 21 paper figure: multistart corner 3 (c_k=0.15, c_eps=0.40) at 200 iterations.
#
...
export REPORT21_OUT_DIR=$HOME/code/Vercor-Autodiff/Results/Report/figures/report-21-paper200/start_3
cd ~/code/Vercor-Autodiff
python Results/Report/scripts/report-21/fit.py
echo "=== REPORT21 START200 3 DONE ==="
