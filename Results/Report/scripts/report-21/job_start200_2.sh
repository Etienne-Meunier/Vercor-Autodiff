#!/bin/bash
# Report 21 paper figure: multistart corner 2 (c_k=0.05, c_eps=1.00) at 200 iterations.
#
...
export REPORT21_OUT_DIR=$HOME/code/Vercor-Autodiff/Results/Report/figures/report-21-paper200/start_2
cd ~/code/Vercor-Autodiff
python Results/Report/scripts/report-21/fit.py
echo "=== REPORT21 START200 2 DONE ==="
